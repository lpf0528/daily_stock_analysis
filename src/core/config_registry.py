...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MARKET_REVIEW_REALTIME_MODE": {
        "title": "Market Review Realtime Mode",
        "description": "Execution mode for realtime market review data: strict (fail if stats unavailable), bounded (fetch with deadline and fall back according to caller policy), disabled (no realtime stats).",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["strict", "bounded", "disabled"]},
        "display_order": 491,
        "help_key": "settings.system.market_review_realtime_mode",
        "examples": [
            "MARKET_REVIEW_REALTIME_MODE=bounded",
            "MARKET_REVIEW_REALTIME_MODE=strict",
        ],
        "docs": [],
        "warning_codes": [],
    },
    "MARKET_REVIEW_TOTAL_TIMEOUT_SECONDS": {
        "title": "Market Review Total Timeout (s)",
        "description": "Total time budget in seconds for fetching realtime market statistics, indices, and sector/concept rankings.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "input",
        "is_sensitive": False,
        ...
        "display_order": 492,
        "help_key": "settings.system.market_review_total_timeout_seconds",
        "examples": ["MARKET_REVIEW_TOTAL_TIMEOUT_SECONDS=25"],
        "docs": [],
        "warning_codes": [],
    },
    "MARKET_REVIEW_PROVIDER_TIMEOUT_SECONDS": {
        "title": "Market Review Provider Timeout (s)",
        "description": "Maximum wait budget per data provider call during market statistics retrieval.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "input",
        "is_sensitive": False,
        ...
        "display_order": 493,
        "help_key": "settings.system.market_review_provider_timeout_seconds",
        "examples": ["MARKET_REVIEW_PROVIDER_TIMEOUT_SECONDS=5"],
        "docs": [],
        "warning_codes": [],
    },
    "MARKET_REVIEW_STATS_PROVIDERS": {
        "title": "Market Review Stats Providers",
        "description": "Priority order of providers for market breadth/statistics (comma separated: tickflow, tushare, sina, efinance, akshare, akshare_em).",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "input",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "tickflow,tushare,sina",
        "options": [],
        "validation": {},
        "display_order": 494,
        "help_key": "settings.data_source.market_review_stats_providers",
        "examples": ["MARKET_REVIEW_STATS_PROVIDERS=tickflow,tushare,sina"],
        "docs": [],
        "warning_codes": [],
    },
    "MARKET_REVIEW_CONCEPT_RANK_SOURCE": {
        "title": "Market Review Concept Ranking Source",
        "description": "Realtime concept/theme ranking source: ths uses the independent InStock Tonghuashun collector (default); eastmoney explicitly enables AkShare's EastMoney concept ranking.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "default_value": "ths",
        "options": [
            {"label": "Tonghuashun (InStock)", "value": "ths"},
            {"label": "EastMoney (AkShare)", "value": "eastmoney"},
        ],
        "validation": {"enum": ["ths", "eastmoney"]},
        "display_order": 495,
        "help_key": "settings.data_source.market_review_concept_rank_source",
        "examples": ["MARKET_REVIEW_CONCEPT_RANK_SOURCE=ths"],
        "docs": [],
        "warning_codes": [],
    },
    "MARKET_REVIEW_STRICT_FOR_ORCHESTRATOR": {
        "title": "Strict Market Review for Orchestrator",
        "description": "Require fresh and complete market review data for orchestrator and market review tasks. Prevents pushing candidate stocks if stats fail.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 496,
        "help_key": "settings.system.market_review_strict_for_orchestrator",
        "examples": ["MARKET_REVIEW_STRICT_FOR_ORCHESTRATOR=true"],
        "docs": [],
        "warning_codes": [],
    },
    "MARKET_REVIEW_ALLOW_STALE_CACHE_SECONDS": {
        "title": "Allow Stale Cache for Market Review (s)",
        "description": "Allowed age in seconds for using stale cache in non-strict modes. Default 0 (stale cache strictly forbidden for current trading day review).",
        "category": "system",
        "data_type": "integer",
        "ui_control": "input",
        "is_sensitive": False,
        ...
        "validation": {"min": 0},
        "display_order": 497,
        "help_key": "settings.system.market_review_allow_stale_cache_seconds",
        "examples": ["MARKET_REVIEW_ALLOW_STALE_CACHE_SECONDS=0"],
        "docs": [],
        "warning_codes": [],
    },
    "MAX_WORKERS": {
